...
記事の誤字訂正についての問い合わせは可能ですが、ギズモード・ジャパンの関係者に情報を共有するため、対応に時間を要します。
...
また、内容の控えを取りたい場合は、テキストエディタやスクリーンショットなどで保存をお願いいたします。
...
ギズモード・ジャパンについての問い合わせの場合（記事についてのお問い合わせを含む）、ギズモード・ジャパン および 株式会社メディアジーンに情報を共有する場合がございます。
